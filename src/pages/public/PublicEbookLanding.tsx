    ...
    <header className={`sticky top-0 z-50 transition-all ${scrolled ? 'bg-white/95 shadow-[0_8px_30px_-12px_rgba(0,47,95,.35)] backdrop-blur' : 'bg-white/80 backdrop-blur'}`}>
      <div className="mx-auto flex max-w-[1240px] items-center justify-between gap-3 px-4 py-2.5 sm:px-6">
        <a href="#top" className="flex items-center gap-2.5">
          <img src={LOGO} alt="METTA Academy" className="h-9 w-auto object-contain sm:h-11" />
        ...
        <button type="button" onClick={scrollToForm} className="lp-cta inline-flex items-center gap-1.5 rounded-full px-4 py-2.5 text-[13px] sm:px-5 sm:text-sm">
