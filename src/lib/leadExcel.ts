...
export const leadExcelColumns: LeadExcelColumn[] = [
  ...
  { key: 'email', label: 'Email', sample: 'phuhuynh@metta.edu.vn' },
  ...
  { key: 'assignedToName', label: 'Sales phụ trách' },
  ...
  return [
    {
      ...base,
      'Lead ID': '',
      'Tên phụ huynh': 'Chị Mai Anh',
      'Tên học sinh': 'Bé An Nhiên',
      'Tên hiển thị': 'Bé An Nhiên',
      'Số điện thoại': '0971999001',
      Email: 'phuhuynh01@metta.edu.vn',
      'Nguồn lead': 'Meta Lead Form',
      'Trung tâm': 'METTA',
      'Cấp độ ưu tiên': 5,
      'Trạng thái': leadStatuses[0],
      'Khóa học quan tâm': 'METTA Kiddies',
      'Ghi chú ban đầu': 'Dòng ví dụ để kiểm tra đúng header import.',
    },
    {
      ...base,
      'Lead ID': '',
      'Tên phụ huynh': 'Anh Minh Quân',
      'Tên học sinh': 'Bé Gia Huy',
      'Tên hiển thị': 'Bé Gia Huy',
      'Số điện thoại': '0971999002',
      Email: 'phuhuynh02@metta.edu.vn',
      'Nguồn lead': 'Referral',
      ...
      'Warmth %': 90,
      'Ghi chú ban đầu': 'Dòng ví dụ có finance để kiểm tra expected revenue.',
    },
  ];
}
