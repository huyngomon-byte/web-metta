...
export const sections: PageSection[] = [
  ...
  { id: 'sec-p2', pageId: 'page-phonics', type: 'Lead Form', title: 'Nhận tư vấn khóa Phonics', formId: 'phonics-form', order: 2, visible: true, createdAt: now, updatedAt: now },
  {
    ...
    title: 'Mùa hè đa bộ môn để con khám phá và tỏa sáng',
    subtitle: 'Chương trình hè 6 tuần cho trẻ 4–11 tuổi với Mỹ thuật, Cờ vua, Thanh nhạc, Nhảy & Múa.',
    description: '24 buổi học · 4 bộ môn · Showcase cuối khóa',
    imageUrl: '/brand/metta-summer-hero-4x3.jpg',
  ...
  },
  {
    ...
    formId: 'metta-summer-2026-landing',
    extraData: JSON.stringify({ highlights: ['Tư vấn lớp hè theo tuổi', 'Gửi lịch học chi tiết', 'Hỗ trợ đăng ký và thanh toán QR'] }),
  },
];
