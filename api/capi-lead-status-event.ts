import { ApiError, requireApiUser } from './_apiAuth.js';
import { adminDb } from './_firebaseAdmin.js';
import { capiEventsForLeadStatus, sendLeadCapiSignal } from './_metaCapi.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'CAPI status event failed.';
